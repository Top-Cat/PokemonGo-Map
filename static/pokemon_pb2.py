...
_REQUESTENVELOP_MESSAGESTOP = _descriptor.Descriptor(
  name='MessageStop',
  full_name='RequestEnvelop.MessageStop',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  fields=[
    _descriptor.FieldDescriptor(
      name='fortid', full_name='RequestEnvelop.MessageStop.fortid', index=0,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ulat', full_name='RequestEnvelop.MessageStop.ulat', index=1,
      ...
      options=None),
    _descriptor.FieldDescriptor(
      name='ulong', full_name='RequestEnvelop.MessageStop.ulong', index=2,
      number=3, type=6, cpp_type=4, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='lat', full_name='RequestEnvelop.MessageStop.lat', index=3,
      number=4, type=6, cpp_type=4, label=2,
      has_default_value=False, default_value=0,
      message_type=None, enum_type=None, containing_type=None,
      is_extension=False, extension_scope=None,
      options=None),
    _descriptor.FieldDescriptor(
      name='long', full_name='RequestEnvelop.MessageStop.long', index=4,
...
_REQUESTENVELOP = _descriptor.Descriptor(
  ...
  nested_types=[_REQUESTENVELOP_REQUESTS, _REQUESTENVELOP_MESSAGESINGLESTRING, _REQUESTENVELOP_MESSAGESINGLEINT, _REQUESTENVELOP_MESSAGETWOINTS, _REQUESTENVELOP_MESSAGEQUAD, _REQUESTENVELOP_MESSAGESTOP, _REQUESTENVELOP_WAT, _REQUESTENVELOP_UNKNOWN3, _REQUESTENVELOP_UNKNOWN6, _REQUESTENVELOP_AUTHINFO, ],
  enum_types=[
  ],
  options=None,
  is_extendable=False,
...
_REQUESTENVELOP_MESSAGESTOP.containing_type = _REQUESTENVELOP
...
RequestEnvelop = _reflection.GeneratedProtocolMessageType('RequestEnvelop', (_message.Message,), dict(
  ...
  MessageStop = _reflection.GeneratedProtocolMessageType('MessageStop', (_message.Message,), dict(
    DESCRIPTOR = _REQUESTENVELOP_MESSAGESTOP,
    __module__ = 'pokemon_pb2'
    # @@protoc_insertion_point(class_scope:RequestEnvelop.MessageStop)
    ))
  ,
...
_sym_db.RegisterMessage(RequestEnvelop.MessageStop)
